 ...
 <div class="col-9"> 
           <div class="row" style="margin-top:10px;"> 
                    ...
                    <div class="col-2 offset-2 border" style="border-radius:500px; padding-top:20px; background:#F9F9F9; height:150px;">
                       ...
                       <?php
					   $sc=pg_query($con, "SELECT count(gr_id) as scount FROM post_grievance where status='Success'");
					   $s=@pg_fetch_array($sc)
					   ?>
                     ...
                     <div class="col-2 offset-3 border" style="border-radius:500px; padding-top:20px;background:#F9F9F9;  height:150px;">
                       ...
                       <?php
					   $pc=pg_query($con, "SELECT count(gr_id) as pcount FROM post_grievance where status='Pending'");
					   $p=@pg_fetch_array($pc)
					   ?>
...
<form action="admin_full_grievance.php" method="post"> 
...
<table class="table offset-1 border table-bordered">
                ...
                <?php
				 $fetch=pg_query($con, "SELECT * FROM post_grievance ORDER BY gr_id DESC");
				 $sr_no=0;
