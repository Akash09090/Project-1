...
<div class=" row left_menu" >
   ...
   ?>
    ...
    <li> <a href="admin_view_old.php"> View Grievance </a></li>
     <li> <a href="add_grievance_type.php"> Grievance Type </a></li>
     <li> <a href="member_view_old.php"> View/Add Members </a></li>
     <li> 
