...
<table class="table offset-1 border table-bordered">
                ...
                <?php
				 $fetch=pg_query($con, "SELECT * FROM post_grievance where status='Pending' ORDER BY gr_id DESC");
				 $sr_no=0;
               ...
               echo "<tr>";
				 ...
				 $gtype=pg_query("SELECT * FROM grr_type where g_id='".$f1['gr_type']."'");
