...
{
	pg_query($con,"update std_registration set std_name='".$_POST['std_name']."', std_course='".$_POST['std_course']."', std_year='".$_POST['std_year']."', std_roll_no='".$_POST['std_roll_no']."', std_email='".$_POST['std_email']."',std_pass='".$_POST['std_pass']."', std_mobile='".$_POST['std_mobile']."' WHERE std_username='".$_SESSION['user']."'") ;
...
<form action="#" method="post" class="form-control">
      ...
      <?php
	  $res=pg_query($con,"SELECT * FROM std_registration WHERE std_username='".$_SESSION['user']."'");
...
<input class="form-control" id="mobile" maxlength="50" name="std_mobile" value="<?php echo $r['std_mobile']; ?>" type="tel" required="required" pattern='^[789][0-9]{9}$'/>
